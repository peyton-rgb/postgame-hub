// ============================================================
// Brief Detail Page — /dashboard/briefs/[id]
...
export default function BriefDetailPage({ params }: { params: { id: string } }) {
  ...
  // Handle "Request Changes" — creates a new draft version
  async function handleRequestChanges() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        router.push(`/dashboard/briefs/${newVersion.id}`);
      }
    } catch (err) {
  ...
  // Navigate to concept generation
  function goToConcepts() {
    router.push(`/dashboard/briefs/${params.id}/concepts`);
  }
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-start justify-between mb-8">
          ...
          <div className="flex gap-3">
            {brief.status === 'draft' && (
              <button
                onClick={() => router.push(`/dashboard/briefs/new?edit=${brief.id}`)}
