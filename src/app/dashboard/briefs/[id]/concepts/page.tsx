    ...
    <div className="min-h-screen bg-[#07070a] text-white p-8">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-6">
            ...
            <div className="mb-6">
              <label className="text-sm text-gray-400 mb-1 block">
                Reference Images
                <span className="text-gray-600 ml-1">(from inspo library or paste a URL)</span>
              </label>
              <div className="flex gap-2 mb-2">
                <button
                  onClick={() => setInspoPickerOpen(true)}
                  className="px-4 py-2.5 bg-[#D73F09]/20 border border-[#D73F09]/30 hover:bg-[#D73F09]/30 text-[#D73F09] rounded-lg text-sm font-medium transition-colors"
                >
        ...
        <div className="grid gap-6">
          {activeConcepts.map((concept) => (
            ...
            >
              ...
              {/* Create Creator Brief — only for approved concepts */}
              {concept.status === 'approved' && (
                <div className="flex gap-3 pt-4 border-t border-gray-800">
                  <button
                    onClick={() =>
      ...
      <InspoPickerModal
        ...
        onSelect={(items: SelectedInspoItem[]) => {
          // Add selected inspo item URLs to reference images
          const newUrls = items
