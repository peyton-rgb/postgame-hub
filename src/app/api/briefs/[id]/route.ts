// ============================================================
// GET /api/briefs/[id]    — Fetch a single brief
// PATCH /api/briefs/[id]  — Update a brief (draft only)
// DELETE /api/briefs/[id] — Soft-delete (set status to cancelled)
// ============================================================
...
// GET: Fetch a single brief by its ID
...
export async function PATCH(
  ...
  // First, check that the brief exists and is still a draft
...
// This keeps the data around for auditing and history.
