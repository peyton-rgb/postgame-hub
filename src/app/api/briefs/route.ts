// ============================================================
// GET /api/briefs  — List all briefs (with optional filters)
// POST /api/briefs — Create a new brief (starts as draft)
// ============================================================
...
// until the user explicitly publishes it via /api/briefs/[id]/publish
