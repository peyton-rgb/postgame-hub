...
const styles = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .browse-cue-label{color:inherit;}
  ...
  return (
    <div style={{ background: "#0A0A0A", minHeight: "100vh" }}>
      ...
      <div className="featured-head">
        <div className="pg-eyebrow section-eyebrow">Spotlight</div>
        <h2 className="pg-h2 section-title">Featured Campaigns</h2>
      </div>
      ...
      <div className="browse-sep">
        ...
        <a href="#all-campaigns" className="browse-cue">
          <span className="pg-eyebrow browse-cue-label">Browse all campaigns</span>
          <span className="browse-cue-arrow" aria-hidden="true">&darr;</span>
        </a>
      </div>

      <section id="all-campaigns" className="section">
        <div className="pg-eyebrow section-eyebrow">Campaign Archive</div>
        <h2 className="pg-h2 section-title">All Campaigns</h2>
              ...
              return (
                <a key={c.id} className={`camp-card${!hasMedia ? ` ${gradient}` : ""}`} href={href}>
                  ...
                  <div className={hasMedia ? "camp-info" : "camp-no-media"}>
                    {brand && <div className="pg-eyebrow camp-brand">{brand}</div>}
                    <div className="pg-h3 camp-name">{c.name}</div>
                  </div>
                </a>
              );
            })}
      ...
      <section className="cta">
        <h2 className="pg-h2 cta-title">Want Your Brand<br />In the Mix?</h2>
        <p className="pg-body cta-sub">We&apos;ve built the playbook. Now let&apos;s run it for your brand.</p>
        <div className="cta-btns">
          <a href="/contact" className="pg-btn btn-solid">Work With Us</a>
          <a href="/clients" className="pg-btn btn-outline">Our Clients</a>
        </div>
      </section>
