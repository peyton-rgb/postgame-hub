...
export default async function ServicesScaledPage() {
  ...
  const { data: carouselRows } = await supabase
    ...
    .eq("slot_key", "svc-scaled.carousel")
    .is("scope_id", null)
    ...
    <div style={{ background: "#0A0A0A", minHeight: "100vh" }}>
      ...
      <div className="hero-wrap">
        ...
        <div className="hero-glass-card">
          <div className="pg-eyebrow service-tag">Scaled NIL</div>
          <h1 className="pg-h1 hero-title">More Athletes.<br />More Markets.<br />More Reach.</h1>
          <p className="pg-lead hero-desc">Scaled campaigns activate 10–500+ athletes simultaneously across every major conference, giving your brand authentic presence at every school that matters to you.</p>
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        ...
        <h2 className="pg-h2 section-title">The Scaled Package</h2>
      ...
      <section className="cta">
        <h2 className="pg-h2 cta-title">Ready to Go<br />Nationwide?</h2>
        <p className="pg-body cta-sub">We&apos;ve run campaigns across every major conference. Let&apos;s build your footprint.</p>
