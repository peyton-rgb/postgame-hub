    ...
    <div style={{ background: "#0A0A0A", minHeight: "100vh" }}>
      ...
      <div className="hero-wrap">
        ...
        <div className="hero-glass-card">
          <div className="pg-eyebrow service-tag">Experiential</div>
          <h1 className="pg-h1 hero-title">In Person.<br />On Camera.<br />In Culture.</h1>
          <p className="pg-lead hero-desc">Experiential activations bring your brand to life at live events — with college athletes as the face of the experience and the content creator on-site.</p>
          ...
          <div className="hero-stats">
            <div><div className="pg-stat stat-num">50+<span></span></div><div className="pg-label stat-label">Live Events</div></div>
            <div><div className="pg-stat stat-num">10M+<span></span></div><div className="pg-label stat-label">Event Impressions</div></div>
            <div><div className="pg-stat stat-num">48<span>hr</span></div><div className="pg-label stat-label">Content Turnaround</div></div>
            <div><div className="pg-stat stat-num">100<span>%</span></div><div className="pg-label stat-label">Athlete Managed</div></div>
          </div>
        </div>
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        ...
        <h2 className="pg-h2 section-title">The Experiential Package</h2>
      ...
      <section className="cta">
        <h2 className="pg-h2 cta-title">Make Your Next<br />Event Unforgettable.</h2>
        <p className="pg-body cta-sub">College athletes bring energy, reach, and authenticity to every activation.</p>
