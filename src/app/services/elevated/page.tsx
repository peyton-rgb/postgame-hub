...
const styles = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .section-desc{font-size:16px;color:var(--text-muted);max-width:640px;line-height:1.7;margin:0 0 48px;}
  ...
  .process-step{display:grid;grid-template-columns:80px 1fr;gap:32px;padding:40px 0;border-bottom:1px solid var(--border);}
  .process-step:last-child{border-bottom:none;}
  .process-num{font-size:48px;line-height:1;color:var(--orange);font-family:'Bebas Neue',Arial,sans-serif;}
  .process-title{font-size:20px;font-weight:800;margin-bottom:8px;}
  .process-desc{font-size:15px;color:var(--text-muted);line-height:1.7;}
  ...
  @media(max-width:900px){
    ...
    .services-nav{padding:0 24px 32px;}
  ...
  return (
    <div style={{ background: "#0A0A0A", minHeight: "100vh" }}>
      ...
      <div className="hero">
        ...
        <h1 className="d hero-title">Tier 1 Athletes.<br />Maximum Impact.</h1>
        <p className="hero-desc">Our Elevated service puts your brand in the hands of the most recognizable college athletes in the country — the ones with the audiences, the influence, and the moment.</p>
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        ...
        <div className="features-grid">
          {[
            { num: "01", title: "Tier 1 Athlete Selection", desc: "Access to our hand-curated network of elite NIL athletes — Heisman candidates, All-Americans, and viral stars with 100K+ followings." },
            { num: "02", title: "Full Creative Direction", desc: "Our team handles scripting, briefing, and creative oversight. Every post is on-brand, on-message, and built to perform." },
            { num: "03", title: "Multi-Platform Distribution", desc: "TikTok, Instagram Reels, YouTube Shorts, and X. We optimize content format for each platform and athlete's strengths." },
            { num: "04", title: "Performance Reporting", desc: "Full campaign dashboard with real-time metrics: reach, impressions, engagement rate, video views, and link performance." },
            { num: "05", title: "Rights & Licensing", desc: "Full usage rights to all athlete content for paid amplification, website, and marketing collateral." },
            { num: "06", title: "Dedicated Campaign Lead", desc: "One point of contact who manages the entire campaign from kickoff to recap — no chasing, no confusion." },
          ].map((f) => (
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        ...
        <h2 className="d section-title">The Process</h2>
        <div className="process">
          {[
            { num: "01", title: "Strategy & Athlete Selection", desc: "We align on your campaign goals, audience, and timeline — then select athletes who match your brand identity and have the reach to move the needle." },
            { num: "02", title: "Creative Briefing", desc: "Our creative team develops scripts, talking points, and shot lists for every athlete. You review and approve before a single video is filmed." },
            { num: "03", title: "Production & Posting", desc: "Athletes shoot content on their own or with our production crew. We QA every deliverable before it goes live." },
            { num: "04", title: "Launch & Amplification", desc: "Content goes live on schedule across all agreed platforms. We can boost top performers with paid spend for additional reach." },
            { num: "05", title: "Recap & Reporting", desc: "You receive a full campaign recap within 5 business days of completion — performance data, content archive, and recommendations for next steps." },
          ].map((s) => (
      ...
      <section className="cta">
        <h2 className="d cta-title">Ready to Run<br />Elevated?</h2>
        <p className="cta-sub">Let&apos;s build a campaign with the athletes your audience already knows and follows.</p>
