...
export default async function ServicesAlwaysOnPage() {
  ...
  const { data: carouselRows } = await supabase
    ...
    .eq("slot_key", "svc-always-on.carousel")
    .is("scope_id", null)
    ...
    <div style={{ background: "#0A0A0A", minHeight: "100vh" }}>
      ...
      <div className="hero-wrap">
        ...
        <div className="hero-glass-card">
          <div className="pg-eyebrow service-tag">Always On</div>
          <h1 className="pg-h1 hero-title">Consistent.<br />Recurring.<br />Always Live.</h1>
          <p className="pg-lead hero-desc">Always On programs keep your brand in front of college audiences year-round with a rotating roster of athletes posting on a recurring schedule.</p>
          ...
          <div className="hero-stats">
            <div><div className="pg-stat stat-num">12<span>mo</span></div><div className="pg-label stat-label">Annual Programs</div></div>
            <div><div className="pg-stat stat-num">4<span>x</span></div><div className="pg-label stat-label">More Touchpoints</div></div>
            <div><div className="pg-stat stat-num">200+<span></span></div><div className="pg-label stat-label">Recurring Athletes</div></div>
            <div><div className="pg-stat stat-num">30<span>%</span></div><div className="pg-label stat-label">Lower CPM</div></div>
          </div>
        </div>
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        ...
        <h2 className="pg-h2 section-title">The Always On Package</h2>
      ...
      <section className="cta">
        <h2 className="pg-h2 cta-title">Stay In Front<br />All Year Long.</h2>
        <p className="pg-body cta-sub">The brands winning with NIL aren&apos;t doing one campaign. They&apos;re always on.</p>
