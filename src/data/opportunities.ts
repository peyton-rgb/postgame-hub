...
export const OPPORTUNITIES: Opportunity[] = [
  ...
  { title: 'Retail & Wholesale Partnerships',  blurb: 'Content tied to product on shelves.' },
  ...
  { title: 'Short- & Long-Form Storytelling',  blurb: 'From 15-second hooks to features.' },
  ...
  { title: 'AI Campaign Intelligence',         blurb: 'Auto-tagging, attribution, recaps.' },
  { title: 'AI Content Creation',              blurb: 'On-brand variations at scale.', isNew: true },
];
