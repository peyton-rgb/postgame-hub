            ...
            >
              ...
              {logoFile && (
                <button
                  ...
                  className="ml-auto w-6 h-6 rounded-full bg-white/10 text-gray-400 hover:text-status-bad hover:bg-status-bad/10 flex items-center justify-center text-sm"
                >
                  ×
                </button>
              )}
