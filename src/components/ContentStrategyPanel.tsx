...
const PRIORITY_BADGES: Record<string, { label: string; classes: string }> = {
  high: { label: 'High', classes: 'bg-status-bad/20 text-status-bad border-status-bad/30' },
  medium: { label: 'Med', classes: 'bg-status-warn/20 text-status-warn border-status-warn/30' },
                                ...
                                {actedOn[s.id] ? (
                                  <div className={`px-3 py-2 rounded-lg text-xs font-medium text-center ${
                                    actedOn[s.id] === 'approved'
                                      ...
                                      : 'bg-status-bad/10 text-status-bad border border-status-bad/20'
                                  }`}>
                                  ...
                                  <div className="flex flex-wrap gap-2 pt-1">
                                    <button
                                      ...
                                      className="px-4 py-1.5 bg-status-ok/10 text-status-ok border border-status-ok/20 rounded-lg text-xs font-medium hover:bg-status-ok/20 transition"
                                    >
                                      Approve & Schedule
                                    </button>
                                    <button
