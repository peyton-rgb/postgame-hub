...
const HIDDEN_ROUTES = ["/admin", "/dashboard", "/board", "/login", "/authorize", "/reset-password", "/media-library", "/brief/", "/run-of-show/", "/recap/", "/optin/", "/bts", "/pitch/", "/portal/", "/pkg/", "/packages", "/athlete", "/v/", "/submit/"];
